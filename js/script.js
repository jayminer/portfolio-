var app = $.sammy('#main', function() {
	...
	this.get('#/projects', function(context) {
		...
		$('#data-hidden > .project').each(function(){
			...
			image = $this.children('.first-image').eq(0).attr('src');
				content.append('<a href="#/projects/' + escape(title) + '"><div class="feature-container '+$this.attr('category')+'" style="opacity:0; background:#'+Math.floor(Math.random()*16777215).toString(16)+' no-repeat;">' +
